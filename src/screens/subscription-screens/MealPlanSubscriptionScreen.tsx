...
const MealPlanSubscriptionScreen = ({navigation}: any) => {
  ...
  const handleSubmit = () => {
    navigation.navigate('MealPlanOne');
  };
  ...
  return (
    <ImageBackground source={backgroundImage} style={styles.backgroundImage}>
      ...
      <MealPlanSubscription
        subscriptionTitle="$3.99 / month"
        styles={
          seletedSubscriptionType === '$3.99 / month' && selectedItemStyles
        }
...
export default MealPlanSubscriptionScreen;
